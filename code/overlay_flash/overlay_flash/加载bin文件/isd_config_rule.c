...
#endif
#define OVERLAY_ADR_START    0X1FA000
#define OVERLAY_LEN_SIZE     0x5000
//mode:
...
FORCE_4K_ALIGN = YES; // force aligin with 4k bytes
SPECIAL_OPT = 1;		// only generate one flash.bin
...
OVERLAY_ADR =  OVERLAY_ADR_START;
OVERLAY_LEN = OVERLAY_LEN_SIZE;
OVERLAY_OPT = 1;
