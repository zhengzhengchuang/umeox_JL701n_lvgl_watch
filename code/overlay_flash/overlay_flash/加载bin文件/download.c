...
cat text.bin data.bin mov_slot.bin data_code.bin aec.bin aac.bin  demo3.bin psram_data_code.bin > app.bin
...
copy /b text.bin + data.bin + data_code.bin + aec.bin + aac.bin + aptx.bin + demo3.bin + common.bin + psram_data_code.bin app.bin
