...
SECTIONS
{
	...
	/*OVERLAY : AT(0x61F1000) SUBALIGN(4)
    {
        .overlay_demo0
        {
            . = ALIGN(4);
...
demo2_addr = ADDR(.overlay_demo2);
demo2_begin = demo1_begin + demo1_size;
demo2_size =  SIZEOF(.overlay_demo2);

demo3_addr = ADDR(.overlay_demo3);
demo3_begin = aac_begin + aac_size;
demo3_size =  SIZEOF(.overlay_demo3);
#endif
/*overlay_bss_addr = ADDR(.overlay_bss);
overlay_bss_begin = demo3_begin + demo3_size;
overlay_bss_size =  SIZEOF(.overlay_bss)*/;
