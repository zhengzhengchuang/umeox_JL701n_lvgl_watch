...
static u8 testbox_update_mode = 0; // 1 - 测试盒经典蓝牙; 2 - 测试盒ble

u8 testbox_update_mode_get(void)
{
    return testbox_update_mode;
}

void testbox_update_mode_set(u8 mode)
{
    testbox_update_mode = mode;
}
