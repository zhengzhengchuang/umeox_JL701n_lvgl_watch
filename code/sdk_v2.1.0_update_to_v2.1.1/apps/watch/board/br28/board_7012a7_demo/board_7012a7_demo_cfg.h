#ifndef CONFIG_BOARD_7012A7_DEMO_CFG_H
#define CONFIG_BOARD_7012A7_DEMO_CFG_H

#include "board_7012a7_demo_global_build_cfg.h"

#ifdef CONFIG_BOARD_7012A7_DEMO
...
#define CONFIG_EX_FLASH_POWER_IO			NULL // NULL // 外置flash电源脚。不接IO时填NULL或者屏蔽掉该宏定义
...
#undef  CONFIG_EXTERN_FLASH_SIZE
#define CONFIG_EXTERN_FLASH_SIZE            0 //配置外挂FLASH大小
