...
#else
/* log system operation wrapper */
#define amp_debug(mod, fmt, ...)     aos_printf(fmt, ##__VA_ARGS__)
#define amp_info(mod, fmt, ...)      aos_printf(fmt, ##__VA_ARGS__)
#define amp_warn(mod, fmt, ...)      aos_printf(fmt, ##__VA_ARGS__)
#define amp_error(mod, fmt, ...)     aos_printf(fmt, ##__VA_ARGS__)
#define amp_fatal(mod, fmt, ...)     aos_printf(fmt, ##__VA_ARGS__)
#define LOG_ERROR(fmt, ...)          aos_printf(fmt, ##__VA_ARGS__)
...
#define AOS_API_NO_INLNE 				//_NOINLINE_
#define AOS_API_CALL_DEBUG(a,...)		//printf("func: %s:%d, "a, __func__, __LINE__, ##__VA_ARGS__);
