...
static const uint16_t al_name_list_ec_w = \
    Al_Name_Container_W;
static const uint16_t al_name_list_ec_h = 108;
static const uint16_t al_name_list_ec_sx = 0;
static const uint16_t al_name_list_ec_sy = 0;

static const uint8_t al_name_list_visual_line = 4;
    ...
    menu_align_t menu_align, uint8_t load_idx, uint8_t load_num)
{
    ...
    for(uint8_t i = load_idx; i < load_idx + load_num; i++)
    {
        ...
        lv_obj_align(elem_00_obj, LV_ALIGN_RIGHT_MID, \
            -40, 5);
    }
    ...
    menu_align_t menu_align, uint8_t load_idx, uint8_t load_num)
{
    ...
    for(uint8_t i = load_idx; i < load_idx + load_num; i++)
    {
        ...
        elem_01_obj = \
            common_widget_label_create(&widget_label_para);
        lv_obj_align(elem_01_obj, LV_ALIGN_TOP_RIGHT, \
            -120, 15);
    }
    ...
    menu_align_t menu_align, uint8_t load_idx, uint8_t load_num)
{
    ...
    for(uint8_t i = load_idx; i < load_idx + load_num; i++)
    {
        widget_label_para.label_parent = \
            al_name_elem_container[i];
        widget_label_para.label_text = \
            GetAllahNameTableEnFr(\
                lang_txt_al_name_00 + i);
        elem_02_obj = \
            common_widget_label_create(&widget_label_para);
        lv_obj_align(elem_02_obj, LV_ALIGN_BOTTOM_RIGHT, \
            -120, 0);
    }
...
static void al_name_list_layout_create(void)
{
    ...
    load_num = al_name_list_visual_line;
