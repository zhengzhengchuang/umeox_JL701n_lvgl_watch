    ...
    menu_align_t menu_align)
{
    ...
    for(uint16_t idx = 0; idx < al_name_list_elem_num; idx++)
    {
        ...
        lv_obj_align(elem_00_label, LV_ALIGN_RIGHT_MID, \
            -40, 0);
    }
    ...
    menu_align_t menu_align)
{
    ...
    for(uint16_t idx = 0; idx < al_name_list_elem_num; idx++)
    {
        widget_label_para.label_parent = \
            al_name_list_elem_container[idx];
        widget_label_para.label_text = \
            al_name_ar_lang_txt_with_id(\
                lang_txt_al_name_00 + idx);
        lv_obj_t *elem_01_label = \
            common_widget_label_create(&widget_label_para);
        lv_obj_align(elem_01_label, LV_ALIGN_TOP_RIGHT, \
            -120, 15);
    }
    ...
    for(uint16_t idx = 0; idx < al_name_list_elem_num; idx++)
    {
        ...
        widget_label_para.label_text = \
            al_name_lang_txt_with_id(\
                lang_txt_al_name_00 + idx);
        lv_obj_t *elem_02_label = \
            common_widget_label_create(&widget_label_para);
        lv_obj_align(elem_02_label, LV_ALIGN_BOTTOM_RIGHT, \
            -120, 0);
    }
