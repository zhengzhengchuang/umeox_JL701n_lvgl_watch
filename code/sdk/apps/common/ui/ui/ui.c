...
volatile lv_img_dsc_t ui_img_step_png;      // assets\step.png
volatile lv_img_dsc_t ui_img_daily_mission_png;      // assets\daily_mission.png
volatile lv_img_dsc_t ui_img_call1_png;      // assets\call1.png
volatile lv_img_dsc_t ui_img_btn_bg_1_png;      // assets\btn_bg_1.png
volatile lv_img_dsc_t ui_img_weather_png;      // assets\weather.png
volatile lv_img_dsc_t ui_img_btn_bg_3_png;      // assets\btn_bg_3.png
//  这张图的圆心在图片外面，不支持硬件解码，直接用内置数组资源
// volatile lv_img_dsc_t ui_img_sec_dot_png;    // assets\sec_dot.png
volatile lv_img_dsc_t ui_img_clockwise_sec_png;      // assets\clockwise_sec.png
volatile lv_img_dsc_t ui_img_clockwise_min_png;      // assets\clockwise_min.png
volatile lv_img_dsc_t ui_img_clockwise_hour_png;      // assets\clockwise_hour.png
volatile lv_img_dsc_t ui_img_bg3_png;      // assets\bg3.png
volatile lv_img_dsc_t ui_img_samatha_png;      // assets\samatha.png
volatile lv_img_dsc_t ui_img_mute_png;      // assets\mute.png
volatile lv_img_dsc_t ui_img_unmute_png;      // assets\unmute.png
volatile lv_img_dsc_t ui_img_house_png;      // assets\house.png
volatile lv_img_dsc_t ui_img_volume_png;      // assets\volume.png
volatile lv_img_dsc_t ui_img_call2_png;      // assets\call2.png
volatile lv_img_dsc_t ui_img_rain_png;      // assets\rain.png
volatile lv_img_dsc_t ui_img_wind_png;      // assets\wind.png
volatile lv_img_dsc_t ui_img_sun_png;      // assets\sun.png
volatile lv_img_dsc_t ui_img_clouds_png;      // assets\clouds.png
volatile lv_img_dsc_t ui_img_weather_sun_png;      // assets\weather_sun.png
volatile lv_img_dsc_t ui_img_weather_cloud_png;      // assets\weather_cloud.png
volatile lv_img_dsc_t ui_img_weather_cloud_fog_png;      // assets\weather_cloud_fog.png
volatile lv_img_dsc_t ui_img_measure_png;      // assets\measure.png
volatile lv_img_dsc_t ui_img_heart_png;      // assets\heart.png
volatile lv_img_dsc_t ui_img_s8_png;      // assets\s8.png
volatile lv_img_dsc_t ui_img_s9_png;      // assets\s9.png
volatile lv_img_dsc_t ui_img_wave2_png;      // assets\wave2.png
volatile lv_img_dsc_t ui_img_wave1_png;      // assets\wave1.png
volatile lv_img_dsc_t ui_img_x_png;      // assets\x.png
volatile lv_img_dsc_t ui_img_bg2_png;      // assets\bg2.png
volatile lv_img_dsc_t ui_img_btn_bg_2_png;      // assets\btn_bg_2.png
volatile lv_img_dsc_t ui_img_heart2_png;      // assets\heart2.png
volatile lv_img_dsc_t ui_img_s1_png;      // assets\s1.png
volatile lv_img_dsc_t ui_img_s2_png;      // assets\s2.png
volatile lv_img_dsc_t ui_img_s3_png;      // assets\s3.png
volatile lv_img_dsc_t ui_img_s4_png;      // assets\s4.png
volatile lv_img_dsc_t ui_img_s5_png;      // assets\s5.png
volatile lv_img_dsc_t ui_img_s6_png;      // assets\s6.png
...
void res_init(){
    #if 0
    open_fd("usr_nor");
    lv_open_res(get_res_fd(), RES_BASE_ADDR, 0, FILE_index[FILE_RGB565_bg1_dat], &ui_img_bg1_png);
    lv_open_res(get_res_fd(), RES_BASE_ADDR, 0, FILE_index[FILE_RGB565_bg1_dat], &ui_img_bg1_png);
    lv_open_res(get_res_fd(), RES_BASE_ADDR, 0, FILE_index[FILE_ARGB8565_flash_dat], &ui_img_flash_png);
    lv_open_res(get_res_fd(), RES_BASE_ADDR, 0, FILE_index[FILE_ARGB8565_weather_sun_cloud_dat], &ui_img_weather_sun_cloud_png);
    lv_open_res(get_res_fd(), RES_BASE_ADDR, 0, FILE_index[FILE_ARGB8565_step_dat], &ui_img_step_png);
    lv_open_res(get_res_fd(), RES_BASE_ADDR, 0, FILE_index[FILE_ARGB8565_daily_mission_dat], &ui_img_daily_mission_png);
    lv_open_res(get_res_fd(), RES_BASE_ADDR, 0, FILE_index[FILE_ARGB8565_call1_dat], &ui_img_call1_png);
    lv_open_res(get_res_fd(), RES_BASE_ADDR, 0, FILE_index[FILE_ARGB8565_btn_bg_1_dat], &ui_img_btn_bg_1_png);
    lv_open_res(get_res_fd(), RES_BASE_ADDR, 0, FILE_index[FILE_ARGB8565_weather_dat], &ui_img_weather_png);
    lv_open_res(get_res_fd(), RES_BASE_ADDR, 0, FILE_index[FILE_ARGB8565_btn_bg_3_dat], &ui_img_btn_bg_3_png);
    // lv_open_res(get_res_fd(), RES_BASE_ADDR, 0, FILE_index[FILE_ARGB8565_sec_dot_dat],  &ui_img_sec_dot_png);//这张图的圆心在图片外面，不支持硬件解码，直接用内置数组资源
    ...
    lv_open_res(get_res_fd(), RES_BASE_ADDR, 0, FILE_index[FILE_RGB565_bg3_dat], &ui_img_bg3_png);
    lv_open_res(get_res_fd(), RES_BASE_ADDR, 0, FILE_index[FILE_ARGB8565_samatha_dat], &ui_img_samatha_png);
    lv_open_res(get_res_fd(), RES_BASE_ADDR, 0, FILE_index[FILE_ARGB8565_mute_dat], &ui_img_mute_png);
    lv_open_res(get_res_fd(), RES_BASE_ADDR, 0, FILE_index[FILE_ARGB8565_unmute_dat], &ui_img_unmute_png);
    lv_open_res(get_res_fd(), RES_BASE_ADDR, 0, FILE_index[FILE_ARGB8565_house_dat], &ui_img_house_png);
    lv_open_res(get_res_fd(), RES_BASE_ADDR, 0, FILE_index[FILE_ARGB8565_volume_dat], &ui_img_volume_png);
    lv_open_res(get_res_fd(), RES_BASE_ADDR, 0, FILE_index[FILE_ARGB8565_call2_dat], &ui_img_call2_png);
    lv_open_res(get_res_fd(), RES_BASE_ADDR, 0, FILE_index[FILE_ARGB8565_rain_dat], &ui_img_rain_png);
    lv_open_res(get_res_fd(), RES_BASE_ADDR, 0, FILE_index[FILE_ARGB8565_wind_dat], &ui_img_wind_png);
    lv_open_res(get_res_fd(), RES_BASE_ADDR, 0, FILE_index[FILE_ARGB8565_sun_dat], &ui_img_sun_png);
    lv_open_res(get_res_fd(), RES_BASE_ADDR, 0, FILE_index[FILE_ARGB8565_clouds_dat], &ui_img_clouds_png);
    lv_open_res(get_res_fd(), RES_BASE_ADDR, 0, FILE_index[FILE_ARGB8565_weather_sun_dat], &ui_img_weather_sun_png);
    lv_open_res(get_res_fd(), RES_BASE_ADDR, 0, FILE_index[FILE_ARGB8565_weather_cloud_dat], &ui_img_weather_cloud_png);
    lv_open_res(get_res_fd(), RES_BASE_ADDR, 0, FILE_index[FILE_ARGB8565_weather_cloud_fog_dat], &ui_img_weather_cloud_fog_png);
    lv_open_res(get_res_fd(), RES_BASE_ADDR, 0, FILE_index[FILE_ARGB8565_measure_dat], &ui_img_measure_png);
    lv_open_res(get_res_fd(), RES_BASE_ADDR, 0, FILE_index[FILE_ARGB8565_heart_dat], &ui_img_heart_png);
    // lv_open_res(get_res_fd(), RES_BASE_ADDR, 0, FILE_index[FILE_RGB565_s8_dat], &ui_img_s8_png);
    // lv_open_res(get_res_fd(), RES_BASE_ADDR, 0, FILE_index[FILE_RGB565_s9_dat], &ui_img_s9_png);
    lv_open_res(get_res_fd(), RES_BASE_ADDR, 0, FILE_index[FILE_ARGB8565_wave2_dat], &ui_img_wave2_png);
    lv_open_res(get_res_fd(), RES_BASE_ADDR, 0, FILE_index[FILE_ARGB8565_wave1_dat], &ui_img_wave1_png);
    lv_open_res(get_res_fd(), RES_BASE_ADDR, 0, FILE_index[FILE_ARGB8565_x_dat], &ui_img_x_png);
    lv_open_res(get_res_fd(), RES_BASE_ADDR, 0, FILE_index[FILE_RGB565_bg2_dat], &ui_img_bg2_png);
    lv_open_res(get_res_fd(), RES_BASE_ADDR, 0, FILE_index[FILE_ARGB8565_btn_bg_2_dat], &ui_img_btn_bg_2_png);
    lv_open_res(get_res_fd(), RES_BASE_ADDR, 0, FILE_index[FILE_ARGB8565_heart2_dat], &ui_img_heart2_png);
    // lv_open_res(get_res_fd(), RES_BASE_ADDR, 0, FILE_index[FILE_ARGB8565_s1_dat], &ui_img_s1_png);
    // lv_open_res(get_res_fd(), RES_BASE_ADDR, 0, FILE_index[FILE_ARGB8565_s2_dat], &ui_img_s2_png);
    // lv_open_res(get_res_fd(), RES_BASE_ADDR, 0, FILE_index[FILE_ARGB8565_s3_dat], &ui_img_s3_png);
    // lv_open_res(get_res_fd(), RES_BASE_ADDR, 0, FILE_index[FILE_ARGB8565_s4_dat], &ui_img_s4_png);
    // lv_open_res(get_res_fd(), RES_BASE_ADDR, 0, FILE_index[FILE_ARGB8565_s5_dat], &ui_img_s5_png);
    // lv_open_res(get_res_fd(), RES_BASE_ADDR, 0, FILE_index[FILE_ARGB8565_s6_dat], &ui_img_s6_png);
    // lv_open_res(get_res_fd(), RES_BASE_ADDR, 0, FILE_index[FILE_ARGB8565_s7_dat], &ui_img_s7_png);
    #endif
}
#endif
...
void ui_event_watch_digital(lv_event_t * e)
{
    ...
    if(event_code == LV_EVENT_GESTURE &&  lv_indev_get_gesture_dir(lv_indev_get_act()) == LV_DIR_LEFT) {
        ...
        _ui_screen_change(ui_watch_analog, LV_SCR_LOAD_ANIM_NONE, 100, 0);
    }
    ...
    if(event_code == LV_EVENT_GESTURE &&  lv_indev_get_gesture_dir(lv_indev_get_act()) == LV_DIR_TOP) {
        lv_indev_wait_release(lv_indev_get_act());
        _ui_screen_change(ui_blood_oxy, LV_SCR_LOAD_ANIM_NONE, 100, 0);
    }
...
void ui_event_button_top_buttontop(lv_event_t * e)
{
    ...
    if(event_code == LV_EVENT_CLICKED) {
        _ui_screen_change(ui_call, LV_SCR_LOAD_ANIM_NONE, 100, 0);
    }
}
void ui_event_button_down_buttondown(lv_event_t * e)
{
    ...
    lv_obj_t * target = lv_event_get_target(e);
    if(event_code == LV_EVENT_CLICKED) {
        _ui_screen_change(ui_weather_1, LV_SCR_LOAD_ANIM_NONE, 100, 0);
    }
}
void ui_event_watch_analog(lv_event_t * e)
{
    ...
    if(event_code == LV_EVENT_GESTURE &&  lv_indev_get_gesture_dir(lv_indev_get_act()) == LV_DIR_LEFT) {
        lv_indev_wait_release(lv_indev_get_act());
        _ui_screen_change(ui_watch_digital, LV_SCR_LOAD_ANIM_NONE, 100, 0);
    }
    if(event_code == LV_EVENT_GESTURE &&  lv_indev_get_gesture_dir(lv_indev_get_act()) == LV_DIR_RIGHT) {
        lv_indev_wait_release(lv_indev_get_act());
        _ui_screen_change(ui_watch_digital, LV_SCR_LOAD_ANIM_NONE, 100, 0);
...
void ui_event_weather_1(lv_event_t * e)
{
    ...
    if(event_code == LV_EVENT_GESTURE &&  lv_indev_get_gesture_dir(lv_indev_get_act()) == LV_DIR_LEFT) {
        lv_indev_wait_release(lv_indev_get_act());
        _ui_screen_change(ui_weather_2, LV_SCR_LOAD_ANIM_NONE, 100, 0);
    }
    if(event_code == LV_EVENT_GESTURE &&  lv_indev_get_gesture_dir(lv_indev_get_act()) == LV_DIR_RIGHT) {
        lv_indev_wait_release(lv_indev_get_act());
        _ui_screen_change(ui_weather_2, LV_SCR_LOAD_ANIM_NONE, 100, 0);
...
void ui_event_blood_oxy(lv_event_t * e)
{
    ...
    if(event_code == LV_EVENT_GESTURE &&  lv_indev_get_gesture_dir(lv_indev_get_act()) == LV_DIR_LEFT) {
        lv_indev_wait_release(lv_indev_get_act());
        _ui_screen_change(ui_ecg, LV_SCR_LOAD_ANIM_NONE, 100, 0);
    }
    if(event_code == LV_EVENT_GESTURE &&  lv_indev_get_gesture_dir(lv_indev_get_act()) == LV_DIR_RIGHT) {
        lv_indev_wait_release(lv_indev_get_act());
        _ui_screen_change(ui_blood_pressure, LV_SCR_LOAD_ANIM_NONE, 100, 0);
    }
}
void ui_event_button_down5_buttondown(lv_event_t * e)
{
...
void ui_event_button_round_buttonround(lv_event_t * e)
{
    ...
    lv_obj_t * target = lv_event_get_target(e);
    if(event_code == LV_EVENT_CLICKED) {
        _ui_screen_change(ui_measuing, LV_SCR_LOAD_ANIM_NONE, 100, 0);
    }
}
void ui_event_ecg(lv_event_t * e)
{
...
void ui_event____initial_actions0(lv_event_t * e)
{
    ...
    if(LV_EVENT_SCREEN_LOADED == event_code){
        printf("load");
        extern volatile u8 usr_full_screen;
        usr_full_screen = 0;  
    }

    if(LV_EVENT_SCREEN_UNLOAD_START == event_code){
        printf("unload");
        extern volatile u8 usr_full_screen;
        usr_full_screen = 1;
    }
...
void ui_init(void)
{
    ...
    lv_obj_center(obj0);
    lv_obj_set_style_bg_color(obj0, lv_color_hex(0xff0000), LV_PART_MAIN);
    lv_obj_set_style_bg_opa(obj0, LV_OPA_20, LV_PART_MAIN);
#if 0
