...
#if 1
LV_IMG_DECLARE_JL(ui_img_bg1_png);    // assets\bg1.png
LV_IMG_DECLARE_JL(ui_img_flash_png);    // assets\flash.png
LV_IMG_DECLARE_JL(ui_img_weather_sun_cloud_png);    // assets\weather_sun_cloud.png
LV_IMG_DECLARE_JL(ui_img_step_png);    // assets\step.png
LV_IMG_DECLARE_JL(ui_img_daily_mission_png);    // assets\daily_mission.png
LV_IMG_DECLARE_JL(ui_img_call1_png);    // assets\call1.png
LV_IMG_DECLARE_JL(ui_img_btn_bg_1_png);    // assets\btn_bg_1.png
LV_IMG_DECLARE_JL(ui_img_weather_png);    // assets\weather.png
LV_IMG_DECLARE_JL(ui_img_btn_bg_3_png);    // assets\btn_bg_3.png
LV_IMG_DECLARE(ui_img_sec_dot_png);    // assets\sec_dot.png//这张图旋转圆心超出了图片范围了
LV_IMG_DECLARE_JL(ui_img_clockwise_sec_png);    // assets\clockwise_sec.png
LV_IMG_DECLARE_JL(ui_img_clockwise_min_png);    // assets\clockwise_min.png
LV_IMG_DECLARE_JL(ui_img_clockwise_hour_png);    // assets\clockwise_hour.png
LV_IMG_DECLARE_JL(ui_img_bg3_png);    // assets\bg3.png
LV_IMG_DECLARE_JL(ui_img_samatha_png);    // assets\samatha.png
LV_IMG_DECLARE_JL(ui_img_mute_png);    // assets\mute.png
LV_IMG_DECLARE_JL(ui_img_unmute_png);    // assets\unmute.png
LV_IMG_DECLARE_JL(ui_img_house_png);    // assets\house.png
LV_IMG_DECLARE_JL(ui_img_volume_png);    // assets\volume.png
LV_IMG_DECLARE_JL(ui_img_call2_png);    // assets\call2.png
LV_IMG_DECLARE_JL(ui_img_rain_png);    // assets\rain.png
LV_IMG_DECLARE_JL(ui_img_wind_png);    // assets\wind.png
LV_IMG_DECLARE_JL(ui_img_sun_png);    // assets\sun.png
LV_IMG_DECLARE_JL(ui_img_clouds_png);    // assets\clouds.png
LV_IMG_DECLARE_JL(ui_img_weather_sun_png);    // assets\weather_sun.png
LV_IMG_DECLARE_JL(ui_img_weather_cloud_png);    // assets\weather_cloud.png
LV_IMG_DECLARE_JL(ui_img_weather_cloud_fog_png);    // assets\weather_cloud_fog.png
LV_IMG_DECLARE_JL(ui_img_measure_png);    // assets\measure.png
LV_IMG_DECLARE_JL(ui_img_heart_png);    // assets\heart.png
// LV_IMG_DECLARE_JL(ui_img_s8_png);    // assets\s8.png
// LV_IMG_DECLARE_JL(ui_img_s9_png);    // assets\s9.png
LV_IMG_DECLARE_JL(ui_img_wave2_png);    // assets\wave2.png
LV_IMG_DECLARE_JL(ui_img_wave1_png);    // assets\wave1.png
LV_IMG_DECLARE_JL(ui_img_x_png);    // assets\x.png
LV_IMG_DECLARE_JL(ui_img_bg2_png);    // assets\bg2.png
LV_IMG_DECLARE_JL(ui_img_btn_bg_2_png);    // assets\btn_bg_2.png
LV_IMG_DECLARE_JL(ui_img_heart2_png);    // assets\heart2.png
// LV_IMG_DECLARE_JL(ui_img_s1_png);    // assets\s1.png
// LV_IMG_DECLARE_JL(ui_img_s2_png);    // assets\s2.png
// LV_IMG_DECLARE_JL(ui_img_s3_png);    // assets\s3.png
// LV_IMG_DECLARE_JL(ui_img_s4_png);    // assets\s4.png
// LV_IMG_DECLARE_JL(ui_img_s5_png);    // assets\s5.png
// LV_IMG_DECLARE_JL(ui_img_s6_png);    // assets\s6.png
// LV_IMG_DECLARE_JL(ui_img_s7_png);    // assets\s7.png
#endif

#else

#include "ui/ui/jl_images/usr_pic_index.h"
#define ui_img_bg1_png      (*"A:"A_SMARTWEAR_UI_BG1)
#define ui_img_flash_png      (*"A:"A_SMARTWEAR_UI_FLASH)
#define ui_img_weather_sun_cloud_png      (*"A:"A_SMARTWEAR_UI_WEATHER_SUN_CLOUD)
#define ui_img_step_png      (*"A:"A_SMARTWEAR_UI_STEP)
#define ui_img_daily_mission_png      (*"A:"A_SMARTWEAR_UI_DAILY_MISSION)
#define ui_img_call1_png      (*"A:"A_SMARTWEAR_UI_CALL1)
#define ui_img_btn_bg_1_png      (*"A:"A_SMARTWEAR_UI_BTN_BG_1)
#define ui_img_weather_png      (*"A:"A_SMARTWEAR_UI_WEATHER)
#define ui_img_btn_bg_3_png      (*"A:"A_SMARTWEAR_UI_BTN_BG_3)
LV_IMG_DECLARE(ui_img_sec_dot_png);    // assets\sec_dot.png//这张图旋转圆心超出了图片范围了
#define ui_img_clockwise_sec_png      (*"A:"A_SMARTWEAR_UI_CLOCKWISE_SEC)
#define ui_img_clockwise_min_png      (*"A:"A_SMARTWEAR_UI_CLOCKWISE_MIN)
#define ui_img_clockwise_hour_png      (*"A:"A_SMARTWEAR_UI_CLOCKWISE_HOUR)
#define ui_img_bg3_png      (*"A:"A_SMARTWEAR_UI_BG3)
#define ui_img_samatha_png      (*"A:"A_SMARTWEAR_UI_SAMATHA)
#define ui_img_mute_png      (*"A:"A_SMARTWEAR_UI_MUTE)
#define ui_img_unmute_png      (*"A:"A_SMARTWEAR_UI_UNMUTE)
#define ui_img_house_png      (*"A:"A_SMARTWEAR_UI_HOUSE)
#define ui_img_volume_png      (*"A:"A_SMARTWEAR_UI_VOLUME)
#define ui_img_call2_png      (*"A:"A_SMARTWEAR_UI_CALL2)
#define ui_img_rain_png      (*"A:"A_SMARTWEAR_UI_RAIN)
#define ui_img_wind_png      (*"A:"A_SMARTWEAR_UI_WIND)
#define ui_img_sun_png      (*"A:"A_SMARTWEAR_UI_SUN)
#define ui_img_clouds_png      (*"A:"A_SMARTWEAR_UI_CLOUDS)
#define ui_img_weather_sun_png      (*"A:"A_SMARTWEAR_UI_WEATHER_SUN)
#define ui_img_weather_cloud_png      (*"A:"A_SMARTWEAR_UI_WEATHER_SUN_CLOUD)
#define ui_img_weather_cloud_fog_png      (*"A:"A_SMARTWEAR_UI_WEATHER_CLOUD_FOG)
#define ui_img_measure_png      (*"A:"A_SMARTWEAR_UI_MEASURE)
#define ui_img_heart_png      (*"A:"A_SMARTWEAR_UI_HEART)
// #define ui_img_s8_png      (*"A:"A_SMARTWEAR_UI_BG1)
// #define ui_img_s9_png      (*"A:"A_SMARTWEAR_UI_BG1)
#define ui_img_wave2_png      (*"A:"A_SMARTWEAR_UI_WAVE2)
#define ui_img_wave1_png      (*"A:"A_SMARTWEAR_UI_WAVE1)
#define ui_img_x_png      (*"A:"A_SMARTWEAR_UI_X)
#define ui_img_bg2_png      (*"A:"A_SMARTWEAR_UI_BG2)
#define ui_img_btn_bg_2_png      (*"A:"A_SMARTWEAR_UI_BTN_BG_2)
#define ui_img_heart2_png      (*"A:"A_SMARTWEAR_UI_HEART2)
