...
//static uint8_t __g_font_buf[468];//如bin文件存在SPI FLASH可使用此buff
...
static uint8_t *__user_font_getdata(int offset, int size){
    ...
    lv_open_font(cpuaddr + font_common_26_no_ch_address + offset, size);
...
//字模高度：36
//XBF字体,外部bin文件
const lv_font_t font_common_26_no_ch = {
