...
#define P2M_LPTIME3_CNT0                                 P2M_MESSAGE_ACCESS(0x027)
#define P2M_LPTIME3_CNT1                                 P2M_MESSAGE_ACCESS(0x028)
#define P2M_LPTIME3_CNT2                                 P2M_MESSAGE_ACCESS(0x029)
#define P2M_LPTIME3_CNT3                                 P2M_MESSAGE_ACCESS(0x02a)
