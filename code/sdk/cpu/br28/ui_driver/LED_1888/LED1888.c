...
#define PIN1_HD  gpio_set_hd(__this->user_data->pin_cfg.pin7.pin[0], 1)
#define PIN1_HD0 gpio_set_hd0(__this->user_data->pin_cfg.pin7.pin[0], 1)
...
#define PIN2_HD  gpio_set_hd(__this->user_data->pin_cfg.pin7.pin[1], 1)
#define PIN2_HD0 gpio_set_hd0(__this->user_data->pin_cfg.pin7.pin[1], 1)
...
#define PIN3_HD  gpio_set_hd(__this->user_data->pin_cfg.pin7.pin[2], 1)
#define PIN3_HD0 gpio_set_hd0(__this->user_data->pin_cfg.pin7.pin[2], 1)
...
#define PIN4_HD  gpio_set_hd(__this->user_data->pin_cfg.pin7.pin[3], 1)
#define PIN4_HD0 gpio_set_hd0(__this->user_data->pin_cfg.pin7.pin[3], 1)
...
#define PIN5_HD  gpio_set_hd(__this->user_data->pin_cfg.pin7.pin[4], 1)
#define PIN5_HD0 gpio_set_hd0(__this->user_data->pin_cfg.pin7.pin[4], 1)
...
#define PIN6_HD  gpio_set_hd(__this->user_data->pin_cfg.pin7.pin[5], 1)
#define PIN6_HD0 gpio_set_hd0(__this->user_data->pin_cfg.pin7.pin[5], 1)
...
#define PIN7_HD  gpio_set_hd(__this->user_data->pin_cfg.pin7.pin[6], 1)
#define PIN7_HD0 gpio_set_hd0(__this->user_data->pin_cfg.pin7.pin[6], 1)
