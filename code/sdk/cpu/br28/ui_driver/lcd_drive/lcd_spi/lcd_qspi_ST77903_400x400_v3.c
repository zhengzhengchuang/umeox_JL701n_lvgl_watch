...
*/
//<<<[qspi屏 400x400]>>>//
#if defined(TCFG_LCD_QSPI_ST77903_V3_ENABLE) && TCFG_LCD_QSPI_ST77903_V3_ENABLE
...
** 初始化代码
*/
static const u8 lcd_qspi_st77903_v3_cmd_list_poweron[] ALIGNED(4) = {
...
*/
static int lcd_qspi_st77903_v3_backlight_ctrl(u8 percent)
{
    if (percent) {
...
** lcd电源控制
*/
static int lcd_qspi_st77903_v3_power_ctrl(u8 onoff)
{
    lcd_en_ctrl(onoff);
    return 0;
}
...
** 设置lcd进入睡眠
*/
static void lcd_qspi_st77903_v3_entersleep(void)
{
...
** 设置lcd退出睡眠
*/
static void lcd_qspi_st77903_v3_exitsleep(void)
{
...
struct imd_param lcd_qspi_st77903_v3_param = {
    .scr_x    = SCR_X,
    .scr_y	  = SCR_Y,
    .scr_w	  = SCR_W,
    .scr_h	  = SCR_H,
...
REGISTER_LCD_DEVICE(st77903_v3) = {
    .logo = "st77903_v3",
    .row_addr_align    = 1,
    .column_addr_align = 1,

    .lcd_cmd = (void *) &lcd_qspi_st77903_v3_cmd_list_poweron,
    .cmd_cnt = sizeof(lcd_qspi_st77903_v3_cmd_list_poweron) / sizeof(lcd_qspi_st77903_v3_cmd_list_poweron[0]),
    .param   = (void *) &lcd_qspi_st77903_v3_param,

    .reset = NULL,	// 没有特殊的复位操作，用内部普通复位函数即可
    .backlight_ctrl = NULL, //lcd_qspi_st77903_v3_backlight_ctrl,
    .power_ctrl = lcd_qspi_st77903_v3_power_ctrl,
    .entersleep = lcd_qspi_st77903_v3_entersleep,
    .exitsleep = lcd_qspi_st77903_v3_exitsleep,
};
