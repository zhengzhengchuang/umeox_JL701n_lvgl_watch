...
void audio_fade_in_fade_out(u8 left_gain, u8 right_gain, u8 fade)
{
    ...
    audio_way_set_digital_gain(AUDIO_OUT_WAY_TYPE, SOUND_CHMAP_FL, __this->digital_volume);
    audio_way_set_digital_gain(AUDIO_OUT_WAY_TYPE, SOUND_CHMAP_FR, __this->digital_volume_r);
